...
- Задача **лексикографічна** на суфіксах ($k$-тий підрядок, найдовший спільний підрядок, кількість різних підрядків через LCP)? *(якщо потрібні переважно підрядкові запити, а не лексикографічний порядок → [Суфіксний автомат](suffix-automaton.md))*
