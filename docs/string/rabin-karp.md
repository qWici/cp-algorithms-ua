...
- Шукаєте **один** взірець у тексті й прийнятна ймовірнісна відповідь (рідкісні колізії хешів допустимі)? *(якщо потрібен детермінований результат → [КМП](prefix-function.md))*
