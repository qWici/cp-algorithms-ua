...
Пошук у глибину знаходить <Term tip="Шлях, який щонайраніше обирає сусіда з найменшим номером: на кожному кроці йде до вершини з найменшим можливим індексом. Серед усіх шляхів він перший в алфавітному (за номерами) порядку.">лексикографічно перший шлях</Term> у графі від початкової вершини $u$ до кожної вершини.
...
- Потрібно обійти граф вглиб: компоненти зв'язності, [пошук циклу](finding-cycle.md), [топологічне сортування](topological-sort.md), часи входу/виходу або перевірка «предок-нащадок»?
- Достатньо будь-якого (лексикографічно першого) шляху, а не найкоротшого за кількістю ребер? *(якщо потрібен найкоротший у незваженому графі → [BFS](breadth-first-search.md))*
- DFS — основа складніших алгоритмів на цій сторінці ([мости](bridge-searching.md), [точки зчленування](cutpoints.md), [компоненти сильної зв'язності](strongly-connected-components.md))?
:::
...
## Застосування пошуку у глибину \{#applications-of-depth-first-search}
  ...
  * Знайти <Term tip="В орієнтованому графі — максимальна група вершин, у якій від кожної можна дійти до будь-якої іншої й повернутися, рухаючись лише за напрямком ребер.">компоненти сильної зв'язності</Term> в орієнтованому графі:
