...
SAT є <Term tip="Клас задач, для яких не відомо швидкого (поліноміального) алгоритму: при зростанні розміру входу час розв'язання вибухово зростає. Знайти розв'язок важко, але перевірити готовий — легко.">NP-повною задачею</Term>, і для неї невідомо жодного ефективного розв'язку.
...
Спершу пригадаємо: якщо одна вершина досяжна з другої, а друга досяжна з першої, то ці дві вершини належать до однієї <Term tip="В орієнтованому графі — максимальна група вершин, у якій від кожної можна дійти до будь-якої іншої й повернутися назад, рухаючись лише за напрямком ребер.">компоненти сильної зв'язності</Term>.
...
Відсортуймо компоненти сильної зв'язності в <Term tip="Лінійне впорядкування вершин орієнтованого графа, у якому кожне ребро веде зліва направо: якщо є шлях з однієї вершини до іншої, перша стоїть у списку раніше.">топологічному порядку</Term> (тобто $\text{comp}[v] \le \text{comp}[u]$, якщо існує шлях з $v$ до $u$), і нехай $\text{comp}[v]$ позначає індекс компоненти сильної зв'язності, до якої належить вершина $v$.
