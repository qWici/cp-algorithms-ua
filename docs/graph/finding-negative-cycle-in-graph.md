...
Нам задано <Term tip="Граф, у якому кожне ребро має напрямок і число-вагу; рухатися ребром можна лише в заданому напрямку.">орієнтований зважений граф</Term> $G$ з $N$ вершинами та $M$ ребрами. Потрібно знайти в ньому будь-який <Term tip="Замкнений маршрут, сума ваг ребер якого від'ємна. Кружляючи ним, можна нескінченно зменшувати довжину шляху.">цикл від'ємної ваги</Term>, якщо такий цикл існує.
