...
У більшості випадків алгоритм Д'Есопо–Папе працює швидше за [алгоритм Дейкстри](dijkstra.md) та [алгоритм Беллмана–Форда](bellman_ford.md), і до того ж він працює з <Term tip="Ребра, вага яких від'ємна (наприклад, перехід, що не додає, а зменшує сумарну вартість шляху).">від'ємними ребрами</Term>.
Проте він не працює з <Term tip="Замкненими маршрутами, сума ваг ребер яких від'ємна. Проходячи такий цикл по колу, можна нескінченно зменшувати довжину шляху, тому найкоротший шлях стає невизначеним.">від'ємними циклами</Term>.
