...
Ось реалізація алгоритму Крускала з <Term tip="прийом у системі неперетинних множин: при злитті менше за висотою дерево підвішують до більшого, щоб дерева не виростали надто глибокими.">об'єднанням за рангом</Term>.
