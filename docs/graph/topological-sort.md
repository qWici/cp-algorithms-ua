...
- Граф **орієнтований і ациклічний** (DAG)? Топологічний порядок існує лише без циклів. *(якщо граф може мати цикли — спершу [знайди цикл](finding-cycle.md) або розбий на [SCC](strongly-connected-components.md))*
