...
Він існує лише тоді, коли орієнтований граф <Term tip="не має жодного замкненого шляху — рухаючись уздовж напрямлених ребер, неможливо повернутися у вихідну вершину.">не містить циклів</Term>.
...
- Граф **орієнтований і ациклічний** (<Term tip="орієнтований граф без циклів (англ. directed acyclic graph).">DAG</Term>)? Топологічний порядок існує лише без циклів. *(якщо граф може мати цикли — спершу [знайди цикл](finding-cycle.md) або розбий на [SCC](strongly-connected-components.md))*
...
Іншими словами, цей список представляє <Term tip="той самий порядок, але записаний у зворотному напрямку — від кінця до початку; щоб отримати звичайний топологічний порядок, його розвертають.">обернений топологічний порядок</Term>.
