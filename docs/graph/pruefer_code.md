...
У цій статті ми розглянемо так званий **код Прюфера** (або послідовність Прюфера) — спосіб однозначно закодувати <Term tip="дерево, у якому всі вершини мають різні номери (мітки), тож дерева з різним розташуванням номерів вважаються різними.">позначене дерево</Term> у вигляді послідовності чисел.
...
Таке кодування також задає **<Term tip="взаємно однозначна відповідність: кожному дереву відповідає рівно одна послідовність і навпаки, без повторів.">бієкцію</Term>** між усіма кістяковими деревами <Term tip="граф, у якому кожна пара вершин з'єднана ребром.">повного графа</Term> і числовими послідовностями.
...
ми вибираємо <Term tip="вершина дерева, з якої виходить лише одне ребро (вона з'єднана лише з однією іншою вершиною).">листок дерева</Term> з найменшим номером, видаляємо його з дерева і записуємо номер вершини, яка була з ним з'єднана.
