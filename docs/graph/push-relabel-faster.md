...
у попередній статті ми обирали <Term tip="вершина, в яку наразі втікає більше потоку, ніж витікає; цей зайвий потік (надлишок) треба кудись проштовхнути.">вершину з надлишком</Term> без жодного особливого правила.
Але виявляється, що якщо ми завжди обиратимемо вершини з **найбільшою <Term tip="допоміжне число для кожної вершини, яке задає, куди можна проштовхувати потік: лише до сусіда з нижчою висотою.">висотою</Term>** й застосовуватимемо до них <Term tip="push — проштовхнути частину надлишку до сусідньої вершини; relabel — підняти висоту вершини, коли проштовхнути потік нікуди.">операції push і relabel</Term>, то складність стане кращою.
