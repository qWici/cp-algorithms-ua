...
- Одна фігура — коло (центр і радіус), а друга — пряма у вигляді $Ax+By+C=0$?
- Друга фігура теж коло, а не пряма? *(якщо так → [Перетин двох кіл](circle-circle-intersection.md))*
