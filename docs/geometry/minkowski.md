...
- Вам справді потрібна поточкова сума $\{a + b\}$ — наприклад, для перевірки колізій рухомих опуклих тіл чи редукції відстані між многокутниками до відстані до точки?
- Вершини многокутників задано в порядку обходу (або їх можна впорядкувати), щоб скористатися злиттям ребер за полярним кутом за $O(|P| + |Q|)$?
:::
