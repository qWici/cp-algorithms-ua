...
2. Прямі та півплощини ми подаватимемо однією точкою й одним вектором (будь-яка точка, що лежить на заданій прямій, та напрямний вектор прямої). У випадку півплощин ми вважаємо, що кожна півплощина дозволяє область ліворуч від свого напрямного вектора. Крім того, кутом півплощини ми називаємо <Term tip="Полярний кут вектора — це кут між ним і додатним напрямком осі Ox, відлічений проти годинникової стрілки; він показує, куди вектор спрямований.">полярний кут</Term> її напрямного вектора. Приклад дивіться на зображенні нижче.
...
Багато задач, які можна розв'язати за допомогою перетину півплощин, також можна розв'язати без нього, але (зазвичай) складнішими чи менш поширеними підходами. Загалом перетин півплощин може з'являтися в задачах, пов'язаних з многокутниками (переважно опуклими), видимістю на площині та двовимірним <Term tip="Лінійне програмування — це пошук найкращого (мінімального чи максимального) значення лінійної функції за умови набору лінійних нерівностей-обмежень.">лінійним програмуванням</Term>. Ось кілька прикладів завдань, які можна розв'язати цією технікою:
