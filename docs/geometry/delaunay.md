...
**Тріангуляція Делоне** $D(\{p_i\})$ множини $\{p_i\}$ — це така тріангуляція, у якій кожна точка $p_i$ лежить поза описаним колом будь-якого трикутника $T \in D(\{p_i\})$ або на його межі.
