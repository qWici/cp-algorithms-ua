...
У цьому випадку достатньо перевірити, чи перетинаються їхні проєкції на $Ox$ і $Oy$.
В іншому випадку точки $a$ і $b$ не повинні лежати по один бік від прямої $(c, d)$, а точки $c$ і $d$ не повинні лежати по один бік від прямої $(a, b)$.
Це можна перевірити за допомогою кількох векторних добутків.
