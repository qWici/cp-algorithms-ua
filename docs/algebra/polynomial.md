...
Сюди входять такі поняття, як множення многочленів, <Term tip="Відновлення многочлена за відомими його значеннями в кількох точках.">інтерполяція</Term>, а також складніші — наприклад, логарифми та експоненти многочленів. У цій статті подано короткий огляд таких операцій та поширених підходів до них.
...
:::
	**Добутком** двох многочленів є вираз, отриманий розкриттям дужок як арифметичного виразу:
	...
	Послідовність $c_0, c_1, \dots, c_{n+m}$ коефіцієнтів $C(x)$ називається **<Term tip="Нова послідовність, кожен елемент якої — сума добутків елементів двох вихідних послідовностей з індексами, що дають у сумі цю позицію.">згорткою</Term>** послідовностей $a_0, \dots, a_n$ та $b_0, \dots, b_m$.
...
Формальні степеневі ряди відіграють вирішальну роль у <Term tip="Розділ комбінаторики, що займається підрахунком кількості об'єктів із заданими властивостями.">перелічувальній комбінаториці</Term>, де їх вивчають як [твірні функції](https://en.wikipedia.org/wiki/Generating_function) для різних послідовностей. Детальне пояснення твірних функцій та інтуїції за ними, на жаль, виходить за межі цієї статті, тому допитливого читача відсилаємо, наприклад, [сюди](https://codeforces.com/blog/entry/103979) за деталями про їхній комбінаторний зміст.
