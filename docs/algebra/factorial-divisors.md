...
Спочатку розглянемо випадок простого $k$. Явний вираз для <Term tip="Добутку всіх натуральних чисел від 1 до n; позначається n зі знаком оклику, наприклад 4! дорівнює 1 множене на 2 множене на 3 множене на 4.">факторіала</Term> має вигляд
...
Цю саму ідею не можна застосувати безпосередньо. Натомість ми можемо розкласти $k$ <Term tip="На прості множники, тобто подати число як добуток простих чисел у відповідних степенях, наприклад 12 = 2 у квадраті, помножене на 3.">на множники</Term>, подавши його у вигляді $k = k_1^{p_1} \cdot \ldots \cdot k_m^{p_m}$. Для кожного $k_i$ ми знаходимо, скільки разів він входить у $n!$, за допомогою описаного вище алгоритму — назвемо це значення $a_i$. Відповідь для складеного $k$ буде
