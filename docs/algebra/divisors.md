...
- Чи потрібно обчислити кількість $d(n)$ або суму $\sigma(n)$ дільників числа через його <Term tip="Запис числа як добутку простих чисел у відповідних степенях, наприклад 60 = 2 у квадраті, помножене на 3, помножене на 5.">розклад на прості множники</Term>?
...
якщо $a$ і $b$ <Term tip="Не мають спільних дільників, окрім одиниці, тобто їхній найбільший спільний дільник дорівнює 1.">взаємно прості</Term>.
...
Наприклад, <Term tip="Спосіб скомбінувати дві функції від натуральних чисел: значення в точці n збирається з добутків їхніх значень по всіх парах дільників, що дають n.">згортка Діріхле</Term> двох мультиплікативних функцій також є мультиплікативною.
