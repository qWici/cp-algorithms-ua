...
В окремому випадку, коли $m$ просте, теорема Ейлера перетворюється на **малу теорему Ферма**:
