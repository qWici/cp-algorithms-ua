...
- Чи рівняння має вигляд конгруенції $a \cdot x \equiv b \pmod n$ з одним невідомим $x$? *(якщо це звичайне рівняння $ax + by = c$ в цілих → [Лінійне діофантове рівняння](linear-diophantine-equation.md))*
