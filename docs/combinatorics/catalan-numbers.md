# Числа Каталана
Числа Каталана — це числова послідовність, яка виявляється корисною в багатьох комбінаторних задачах, часто пов'язаних з <Term tip="Об'єкти, які будуються з менших копій самих себе: наприклад, дерево складається з піддерев, а дужкова послідовність — з коротших дужкових послідовностей.">рекурсивно визначеними об'єктами</Term>.
...
- Чи задача про підрахунок збалансованих рекурсивних структур — правильних [дужкових послідовностей](bracket_sequences.md), бінарних дерев, тріангуляцій многокутника, неперетинних хорд/розбиттів?
- Чи треба лише *порахувати* кількість, а не *згенерувати* самі об'єкти? *(якщо ні → [Генерування комбінацій](generating_combinations.md) або [Дужкові послідовності](bracket_sequences.md))*
:::
...
- Кількість <Term tip="Шляхи по клітинковій сітці, що йдуть лише вправо або вгору, тобто ніколи не повертають назад чи вниз.">монотонних шляхів</Term> на ґратці з точки $(0, 0)$ до точки $(n, n)$ у квадратній ґратці розміру $n \times n$, які не проходять вище головної діагоналі (тобто тієї, що з'єднує $(0, 0)$ з $(n, n)$).
