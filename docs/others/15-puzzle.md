...
- Чи зводиться допустимий хід до переміщення порожньої клітинки між сусідами (тобто чи <Term tip="Величина, яка не змінюється від жодного допустимого ходу. Якщо вона різна в початковій і цільовій позиціях, розв'язку не існує.">інваріант</Term> — парність перестановки + рядок порожньої клітинки)?
- Чи можна закодувати позицію як **<Term tip="Спосіб розташування набору чисел у певному порядку. Тут це порядок фішок на дошці.">перестановку</Term>** й порахувати кількість <Term tip="Пара фішок, що стоять у неправильному порядку: більше число йде раніше за менше.">інверсій</Term>?
:::
